declare const TlInputNumber: import('@teal/utils').SFCWithInstall<import('vue').DefineComponent<import('./src/input-number').InputNumberProps, {}, {}, {}, {}, import('vue').ComponentOptionsMixin, import('vue').ComponentOptionsMixin, {
    "update:modelValue": (...args: any[]) => void;
    increase: (...args: any[]) => void;
    decrease: (...args: any[]) => void;
}, string, import('vue').PublicProps, Readonly<import('./src/input-number').InputNumberProps> & Readonly<{
