...
var _chunkR2KEYI3Ojs = require('./chunk-R2KEYI3O.js');
...
function isTs(lang) {
  return lang && _chunkR2KEYI3Ojs.REGEX_TS_FILE.test(lang);
}
function babelParse(code, lang, options = {}) {
  ...
  if (lang) {
    ...
    if (_chunkR2KEYI3Ojs.REGEX_JSX_FILE.test(lang))
      plugins.push("jsx");
  }
...
function isStaticExpression(node) {
  ...
  if ((_a = node.leadingComments) == null ? void 0 : _a.some(
    (comment) => comment.value.trim() === _chunkR2KEYI3Ojs.MAGIC_COMMENT_STATIC
  ))
    return true;
  switch (node.type) {
...
exports.getLang = getLang; exports.isTs = isTs; exports.babelParse = babelParse; exports.isCallOf = isCallOf; exports.checkInvalidScopeReference = checkInvalidScopeReference; exports.isStaticExpression = isStaticExpression; exports.isLiteralType = isLiteralType; exports.getStaticKey = getStaticKey; exports.walkAST = walkAST;
